...
public class RutaController {
	...
	@PreAuthorize("hasRole('ADMINISTRATOR') or hasRole('USER_WEB')")
	public Ruta updateRutaWithGPX(@RequestParam("file") MultipartFile file,@RequestParam("linea") String linea) throws IOException {
		return rutaService.updateRutaWithGPX(file, linea);
	}
